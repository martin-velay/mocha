...
(
    ...
    function automatic hpdcache_data_row_enable_t hpdcache_compute_data_ram_cs(
        ...
        case (size_i)
            3'h0:    ret = hpdcache_data_row_enable_t'({hpdcache_ceil_div(  8,HPDcacheCfg.u.wordWidth){1'b1}});
            3'h1:    ret = hpdcache_data_row_enable_t'({hpdcache_ceil_div( 16,HPDcacheCfg.u.wordWidth){1'b1}});
            3'h2:    ret = hpdcache_data_row_enable_t'({hpdcache_ceil_div( 32,HPDcacheCfg.u.wordWidth){1'b1}});
            3'h3:    ret = hpdcache_data_row_enable_t'({hpdcache_ceil_div( 64,HPDcacheCfg.u.wordWidth){1'b1}});
            3'h4:    ret = hpdcache_data_row_enable_t'({hpdcache_ceil_div(128,HPDcacheCfg.u.wordWidth){1'b1}});
            3'h5:    ret = hpdcache_data_row_enable_t'({hpdcache_ceil_div(256,HPDcacheCfg.u.wordWidth){1'b1}});
            default: ret = hpdcache_data_row_enable_t'({hpdcache_ceil_div(512,HPDcacheCfg.u.wordWidth){1'b1}});
        endcase
    ...
    begin : data_ctrl_comb
        ...
        unique case (1'b1)
            ...
            data_req_read_i: begin
                ...
                if (HPDcacheCfg.u.userEn) user_cs = '1;
            end
            ...
            data_write: begin
                ...
                if (HPDcacheCfg.u.userEn) user_cs = data_way;
            end
